...
class SelectImageVC: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        if let selectedImage = self.selectedImage {
            ...
            if let index = self.images.index(of:selectedImage){
                ...
                // request image
                imageManager.requestImage(for: selectedAsset, targetSize: targetSize, contentMode: .default, options: nil) { (image, infor) in
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        self.collectionView.reloadData() // reload lai data len man hinh
    ...
    func getAssetFetchOptions()->PHFetchOptions{
        ...
        //set sort descriptior for option
    ...
    func fetchPhoto(){
        ...
        DispatchQueue.global(qos: .background).async {
            ...
            allPhotos.enumerateObjects ({ (asset, count, stop) in
                ...
                // count : count how many photo in library
                let imageManager = PHImageManager.default()
                ...
                imageManager.requestImage(for: asset, targetSize: targetSize, contentMode: .aspectFit, options: options) { (image, infor) in
                    if let image = image {
                        ...
                        // reload collection view with images onc e count has completed
